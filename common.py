...
class Grader():
    ...
    def execute_test(self, test_suite_name, test_num, args, is_valgrind, diff_type, timeout=None):
        """
        ...
        if self.make_expected: # special mode to generate expected outputs - kinda hacky in how it short circuits things
            ...
            if self.mode == "spim":
                try:
                    self.spim_clean(expected_output_filename)
